...
SMODS.Back {
    ...
    loc_vars = function(self, info_queue, back)
        return { vars = { self.config.extra.voucherslots, localize { type = 'name_text', key = self.config.voucher, set = 'Voucher' }
            } }
...
SMODS.Back {
    ...
    loc_vars = function(self, info_queue, back)
        return { vars = { self.config.extra.uncommon_rarity, self.config.extra.rare_rarity
            } }
